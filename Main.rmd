...
if(extract_analyse){
  ...
  dataset <- readRDS("output/data/SingleSpecies_RStan_GRecondita.rds")
  ...
  save_filename <- "output/data/GRecondita_Sampled_Canham.rds"
  saveRDS(save_data, file=save_filename)
  
  #Load if needed
  save_data <- readRDS("output/data/GRecondita_Sampled_Canham.rds")
  ...
  plot_sample_life_history(post_pars, growth_function, 
                           name = "GRecondita_Posterior_Samples", 
